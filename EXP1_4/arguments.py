...
def get_argument_parser():
    ...
    parser.add_argument('--data_path', default='/root/cvpr26/data',
    ...
    parser.add_argument('--lr_update', default=[9, 15, 20, 25], type=int,
    ...
    parser.add_argument('--logger_name', default='/root/autodl-tmp/runs/runX/log',
                        help='Path to save Tensorboard log.')
    parser.add_argument('--model_name', default='/root/autodl-tmp/runs/runX/checkpoint',
    ...
    parser.add_argument('--precomp_enc_type', default="backbone",
                        help='basic|backbone')
    parser.add_argument('--backbone_path', type=str, default='/root/cvpr26/data/vit_base_patch16_224.augreg_in21k_timm/pytorch_model.bin',
    ...
    parser.add_argument('--num_attribute', type=int, default=500,
                        help='The number of visual concepts')
    parser.add_argument('--generated_caps_path', type=str,
                    default='/root/cvpr26/data/v2t_llava_generate.txt',
                    help='Path to the text file containing generated captions.')
