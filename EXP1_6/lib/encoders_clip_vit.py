...
class OSIT(nn.Module):
    def __init__(self, embed_size):
        ...
        # 图像分支（有 Saa）
        self.de_decoder_vis = Denoise_Decoder(seq_len_q = self.keeped_patches + 2, seq_len_k=900, hidden_dim=900)
    ...
    def forward(self, base_features, t_features, g_t_features, g_cap_emb, global_feature=None):
        ...
        concept_basis = torch.cat([text_concept_basis, visual_concept_basis], dim=0)
