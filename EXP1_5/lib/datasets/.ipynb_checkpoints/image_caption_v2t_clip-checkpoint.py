...
class RawImageDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 长文本处理：直接加载预计算好的 CLIP 文本特征
        long_target_ft = torch.tensor(self.long_caption_features[img_index-1], dtype=torch.float32)
        ...
        # print('img_index:',img_index,'original_caption:',original_caption,'image_id:',image_id)
        # print(long_target_ft.shape)
